...
def main():
    ...
    llm = LLM(config, config.default_model_type, config.default_model_name)  # 创建语言模型实例
    ...
    command_handler = CommandHandler(github_client, subscription_manager, report_generator, config)  # 添加 config 参数
